    ...
    @if (count($shots) > $initial)
        ...
        <div class="mt-6 text-center">
            <button @click="showAll=!showAll"
                    class="inline-flex items-center rounded-xl px-4 py-2 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800">
