<x-guest-layout>
    <div class="py-10 bg-blend-darken  md:py-16">
        <div class="px-10 mx-auto max-w-7xl md:px-16">
            ...
            <form id="contact-form" class="grid max-w-3xl gap-4 mx-auto sm:grid-cols-2" action="{{ route('contact.store') }}" method="POST">
                @csrf
                <div>
                    <x-label for="first_name" class="inline-block mb-2 text-sm font-medium text-zinc-300 sm:text-base">First name</x-label>
                    <x-input autofill required name="first_name" class="w-full px-3 py-2 text-zinc-800 transition duration-100 border rounded-md outline-none bg-zinc-50 focus:ring ring-blue-300"  />
                </div>

                <div>
                    <x-label for="last_name" class="inline-block mb-2 text-sm font-medium text-zinc-300 sm:text-base">Last name</x-label>
                    <x-input autofill required name="last_name" class="w-full px-3 py-2 text-zinc-800 transition duration-100 border rounded-md outline-none bg-zinc-50 focus:ring ring-blue-300" />
                </div>

                <div class="sm:col-span-2">
                    <x-label for="company" class="inline-block mb-2 text-sm font-medium text-zinc-300 sm:text-base">Company</x-label>
                    <x-input autofill name="company" class="w-full px-3 py-2 text-zinc-800 transition duration-100 border rounded-md outline-none bg-zinc-50 focus:ring ring-blue-300" />
                </div>

                <div class="sm:col-span-2">
                    <x-label for="email" class="inline-block mb-2 text-sm font-medium text-zinc-300 sm:text-base">Email</x-label>
                    <x-input autofill required name="email" class="w-full px-3 py-2 text-zinc-800 transition duration-100 border rounded-md outline-none bg-zinc-50 focus:ring ring-blue-300" />
                </div>

                <div class="sm:col-span-2">
                    <x-label for="subject" class="inline-block mb-2 text-sm font-medium text-zinc-300 sm:text-base">Subject</x-label>
                    <x-input autofill required name="subject" class="w-full px-3 py-2 text-zinc-800 transition duration-100 border rounded-md outline-none bg-zinc-50 focus:ring ring-blue-300" />
                </div>

                <div class="sm:col-span-2">
                    <x-label for="message" class="inline-block mb-2 text-sm font-medium text-zinc-300 sm:text-base">Message</x-label>
                    <textarea autofill required name="message" class="w-full h-64 px-3 py-2 text-zinc-800 transition duration-100 border rounded-md outline-none bg-zinc-50 focus:ring ring-blue-300"></textarea>
                </div>
