...
@section('title', 'Contact Keith Prinkey – Web Development Services')
    ...
    <form wire:submit.prevent="save" class="mt-12 max-w-3xl mx-auto">
        ...
        <x-section-title>
            ...
            <x-slot name="description">
                Please fill out the form below. <strong>Or</strong> you can schedule a meeting with me via the 'Schedule
                Time with Me' button at the bottom right of your screen. This form should only take around 30 seconds to
                complete!
            </x-slot>
        </x-section-title>
        ...
        <div class="grid grid-cols-6 gap-4 rounded-xl">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input id="email" type="email" class="mt-1 block w-full" wire:model.defer="form.email"
                         autocomplete="email"/>
            ...
            <div class="col-span-6">
                ...
                <x-input id="company"
                         class="mt-1 block w-full rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                         wire:model.defer="form.company" rows="4"></x-input>
                <x-input-error for="form.company" class="mt-2"/>
            </div>

            <div class="col-span-6">
                <x-label for="project_type" value="Project Type"/>
                <x-input id="project_type"
                         class="mt-1 block w-full rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                         wire:model.defer="form.project_type" rows="4"></x-input>
                <x-input-error for="form.project_type" class="mt-2"/>
            </div>

            <div class="col-span-6">
                <x-label for="budget_range" value="Budget Range"/>
                <x-input id="budget_range"
                         class="mt-1 block w-full rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                         wire:model.defer="form.budget_range" rows="4"></x-input>
                <x-input-error for="form.budget_range" class="mt-2"/>
            </div>

            <div class="col-span-6">
                <x-label for="decision_timeline" value="Decision Timeline"/>
                <x-input id="decision_timeline"
                         class="mt-1 block w-full rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                         wire:model.defer="form.decision_timeline" rows="4"></x-input>
